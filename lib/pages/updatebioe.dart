...
class UpdateBioEPage extends StatefulWidget {
  UpdateBioEPage({Key key}) : super(key: key);

  @override
  _UpdateBioEPageState createState() => _UpdateBioEPageState();
}


class _UpdateBioEPageState extends State<UpdateBioEPage>{
...
final key = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context){
    ...
    updateBio(String temp) async {
      /*Map data = {
        'test': bio
      };
      var jsonResponse = null;
      await http.post("http://10.0.2.2:3000/users/$user", body: data);*/
